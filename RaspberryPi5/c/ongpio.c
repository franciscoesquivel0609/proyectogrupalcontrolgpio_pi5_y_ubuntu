...
int main(void) {
	...
	pinMode(PIN3, OUTPUT); //Configura el pin fisico 15 del modo tipo salida
        ...
        printf("Apagado GPIO17,GPIO27,GPIO22 (Pin fisico 11,13,15)...\n");
        digitalWrite(PIN0, LOW); //Encender gpio
	digitalWrite(PIN2, LOW); //Encender gpio
	digitalWrite(PIN3, LOW); //Encender gpio
        //delay(2000);
